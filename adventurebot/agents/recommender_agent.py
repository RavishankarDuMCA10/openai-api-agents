...
PROMPT = """You evaluate potential activities and create a final travel plan.
    Given the list of potential activities (ActivityResults), the weather analysis (weatherAnalysis),
    and the original trip query details (location, dates, participants):
    1. Evaluate each activity based on:
        ...
        - Paractical considerations (cost, duration, accessibility inferred from descripation).
